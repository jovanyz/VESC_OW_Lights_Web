...
long Default(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
...
long Rainbow(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;                   //  Seq position not relevant for this so return current
}
...
// onoff option sets colors from right to left instead of left to right
long ColorWipe(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
...
long ColorFade(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
...
long Lava(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}
...
long Canopy(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}
...
long Ocean(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}
...
long RollingWave(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position +1;
}


// From first pixel to last add LED at a time then stay lit
long ColorWave(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}

// From all on remove LED at a time then stay off
long Fireflies(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}


// turn all on one at a time, then all off again
long Confetti(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}


long Comet(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}
...
long Sunset(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}
...
//     sequence = (num_pixels/2)+1 if even
//     sequence = (num_pixels/2)+2 if odd 
long PixelFinder(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}
...
//     sequence = (num_pixels/2)+1 if even
//     sequence = (num_pixels/2)+2 if odd 
long unused0(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}
...
long unused1(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}
...
long unused2(long mode_position, bool onoff, uint32_t colors[], int num_colors) {
  return mode_position;
}
